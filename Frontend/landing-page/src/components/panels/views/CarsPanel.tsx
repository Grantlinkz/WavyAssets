...
import { FileText, Lock, Warehouse } from 'lucide-react';
...
export const CarsPanel: React.FC = () => {
  ...
  const inventory = [
    ...
    },
    {
      ...
      provenance: 'Chassis #073 • High Downforce Kit • F1 Factory Works',
      depot: 'Geneva Bonded Freeport',
      value: '$24,800,000',
    ...
    },
    {
      ...
      provenance: 'Chassis #005 • FIA GT Homologation • 5,400km Documented',
      depot: 'Zurich Freeport Vault 2',
      value: '$16,200,000',
    ...
    },
    {
      ...
      depot: 'Geneva Micro-Vault Enclave',
      value: '$9,400,000',
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2 py-0.5 bg-surface-container-high text-primary font-mono text-[10px] uppercase tracking-widest rounded-sm border border-outline/20">
                [ SOVEREIGN PHYSICAL ASSET VERTICAL // TIER-1 FREEPORT DEPOT ]
              </span>
              <span className="px-2 py-0.5 bg-secondary/15 text-secondary font-mono text-[10px] uppercase tracking-wider rounded-sm flex items-center gap-1 border border-secondary/20">
                ...
                NON-HYPOTHECATED ALLOCATION
              </span>
            </div>

            <h3 className="font-headline-xl text-2xl sm:text-3xl text-on-surface font-bold tracking-tight">
              Exotic &amp; Historical Vehicle Vault
            </h3>

            <p className="font-sans text-xs sm:text-sm text-on-surface-variant leading-relaxed">
              Swiss bonded vault storage, certified works provenance, climate-monitored preservation
              (19&deg;C / 48% RH), and cryptographic title deed tokenization under Swiss FinIA and
              Delaware SPV structures. Non-hypothecated tangible reserve assets eligible for
              programmatic cross-collateralization.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                ...
                <span>Request Acquisition Slot</span>
              </button>
              <button
                type="button"
                onClick={() => openAuthModal('institutional')}
          ...
          <div className="lg:col-span-5 bg-surface-container-lowest p-4 rounded-sm border border-outline/20 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1">
              <div className="bg-surface-container-low p-2.5 rounded-sm border border-outline/20">
                ...
                <div className="font-mono text-[9px] text-outline">CLASSICHE-250</div>
              </div>
              <div className="bg-surface-container-low p-2.5 rounded-sm border border-outline/20">
                <div className="font-sans text-[10px] text-outline uppercase">STORED UNITS</div>
                <div className="font-mono text-xl font-bold text-on-surface pt-0.5">38 Cars</div>
                <div className="font-mono text-[9px] text-primary">$184.2M Mapped</div>
              </div>
              <div className="bg-surface-container-low p-2.5 rounded-sm border border-outline/20">
                ...
                <div className="font-mono text-[9px] text-secondary">48% RH NOMINAL</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <span className="font-sans text-xs text-primary uppercase tracking-widest font-bold flex items-center gap-1.5">
            ...
            FREEPORT BONDED INVENTORY (FEATURED VAULT ASSETS)
          </span>
            ...
            >
              ...
              <div className="pt-3 border-t border-outline/20 flex items-center justify-between text-xs">
                <div>
                  ...
                  <span className="font-sans text-on-surface text-xs font-semibold">
                    {item.depot}
                  </span>
                </div>
                <div className="text-right">
                  ...
                  <span className="font-mono text-base font-bold text-primary">{item.value}</span>
                </div>
              </div>
            </div>
          ))}
