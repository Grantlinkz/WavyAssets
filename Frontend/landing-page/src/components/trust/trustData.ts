  ...
  institutional: [
    {
      ...
      badgeType: 'emerald',
      value: '$12.40B',
      subtitle: 'Institutional & Global Balance Sheets',
      progressPercent: 92,
      progressColor: 'secondary',
    },
    {
  ...
  institutional: [
    {
      ...
      quote:
        '“Managing liquidity across Global debt tranches, institutional GPU clusters, and tokenized commercial properties requires uncompromised deterministic settlement. WavyAssets enclave architecture sets the gold benchmark.”',
      initials: 'SZ',
      avatarUrl: avatarTariq,
      name: 'Sheikh Tariq Al-Zahrani',
      role: 'Chief Investment Officer, Global Capital Authority',
