...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  const handleHomeClick = (e: React.MouseEvent | React.KeyboardEvent) => {
    ...
    useDashboardStore.getState().setActiveVertical('overview');
    ...
    >
      ...
      >
        ...
        <text
          x="42"
          y="23"
          className="fill-on-surface font-serif font-bold tracking-[0.12em]"
          fontSize="15"
        >
          WAVY
        </text>
        <text
          ...
          y="23"
          fill="#D4AF37"
          className="font-serif font-medium tracking-[0.12em]"
          fontSize="15"
        >
          ASSETS
        </text>
