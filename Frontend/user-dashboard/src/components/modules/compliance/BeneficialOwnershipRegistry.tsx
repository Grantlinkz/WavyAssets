          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <p className="font-sans text-xs text-outline leading-relaxed">
                Periodic Swiss private banking due diligence renewal for consolidated portfolio NAV ($14.82M across 7 verticals). Pre-filled affidavit prepared by Treuhand Zurich.
              </p>
            </div>
          </div>
