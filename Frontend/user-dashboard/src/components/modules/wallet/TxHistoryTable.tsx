    ...
    <div className="bg-surface-container-lowest border border-border-hairline rounded-DEFAULT">
      ...
      <div className="p-3 border-b border-border-hairline flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3 bg-surface-container-low">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center bg-surface-container-lowest border border-border-hairline p-0.5 rounded-DEFAULT">
            {filterOptions.map((opt) => (
              <button
                key={opt.value}
                type="button"
                onClick={() => setFilterVertical(opt.value)}
                className={`px-2 py-0.5 font-mono text-[11px] rounded-DEFAULT transition-colors ${
          ...
          <button
            ...
            className="px-2 py-1 bg-surface-container hover:bg-surface-container-high border border-border-hairline text-on-surface font-mono text-[11px] rounded-DEFAULT flex items-center gap-1 transition-colors"
          >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-border-hairline bg-surface-container-low/60 text-outline text-[11px] font-mono uppercase tracking-wider">
